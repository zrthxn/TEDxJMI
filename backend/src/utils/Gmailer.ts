...
export interface MailProto {

}

export const SingleDelivery = (mail) => {
...
export const SingleDataDelivery = (mail, content, data) => {
...
export const DatasetDelivery = (mail, content, database) => {
...
export const DistributedCampaign = (mail, content, database, options) => {
  var MAX_DATA = 50
  var payload = []
...
export const setFrequency = function(freq) {
  sendFrequency = freq
