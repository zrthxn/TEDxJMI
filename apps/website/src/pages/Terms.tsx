    ...
    return (
      <div>
        ...
        <div style={{ textAlign: 'left', padding: '2em', maxWidth: 800, margin: 'auto' }}>
          <h3>REGISTRATION</h3>
          <ul>
            <li>By registering and making a payment you agree that all details provided are accurate. Any discrepancy may result in cancellation of registration.</li><br/>
